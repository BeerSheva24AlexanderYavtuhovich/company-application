...
public class CompanyItems {
    ...
    private static final Item[] EXIT_MENU = {
            Item.of("Save", io -> save(io, true, false)),
            Item.of("Save and exit", io -> save(io, true, true)),
            Item.of("Exit", io -> save(io, false, true)),
            Item.of("Back to Main Menu", io -> {}, true)
    };
    private static final Item[] MAIN_MENU = {
            ...
            Item.of("Save / Exit", io -> getSubMenu(io, "Select Action:", EXIT_MENU))
    };
    ...
    private static void subMenuDepBudget(InputOutput io) {
        ...
        departmentBudgetMenu.add(Item.of("Back to Main Menu", iO -> {}, true));
